...
local alice = assert(QuestInfoList[62090], "Alice admission guide missing")
assert(alice.CoolTimeQuest == 1)
assert(alice.Summary == "Resets at 04:00 server time")
assert(table.concat(alice.Description):find("Easy and Hard modes share this cooldown", 1, true))
