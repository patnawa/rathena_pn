...
Bold 13-cell requests use character height 11. Runtime diagnostics identified
...
and 12 pixels still a little too large; profile 6 uses 11 pixels. The
separate 11-cell inventory fonts retain their original size. Other labels
sharing the bold 13-cell font also use 11 pixels.
